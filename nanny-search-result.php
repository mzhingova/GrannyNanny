...
//Going to first page
echo "<a href='search.php?page=1".$url_query."'>".'First Page'."</a> ";

	for ($i=1; $i<=$total_pages; $i++) {

		echo " <a href='search.php?page=".$i.$url_query."'>".$i."</a> ";
	}
	// Going to last page
echo "<a href='search.php?page=$total_pages".$url_query."'>".'Last Page'."</a> "; 
}
/* else {
